...
const Hero = () => {
  ...
  return (
    <div   className='relative flex items-center justify-center h-screen px-20 text-center'
    style={{
    ...
    >
      ...
      <h1 data-scroll data-scroll-speed="10" className='z-40 text-[#f1d031] md:text-[6em] text-5xl uppercase font-permanent-marker leading-[1em]'>Amazing  <em>Experience</em> <br/>Are what power us</h1>
    </div>
  )
}
